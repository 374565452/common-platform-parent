...
public class GatewaySocketHandler extends SimpleChannelInboundHandler<String> {
	private ChannelGroup group;// = new
	// DefaultChannelGroup(ImmediateEventExecutor.INSTANCE);

	public GatewaySocketHandler(ChannelGroup group) {
		this.group = group;
	}
	...
	protected void channelRead0(ChannelHandlerContext ctx, String msg) throws Exception {
		...
		// DeviceFactory.getInstance().invokeData(ctx.channel().hashCode(),
		// msg);
