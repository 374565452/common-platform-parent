...
public class CommonClassUtils {
	 ...
	 * @throws IOException
	 */
	public static Set<Class<?>> getBusinessClasses(String pack) throws ClassNotFoundException, IOException {
		// 第一个class类的集合
...
class ClassFilter implements FileFilter {
	...
	public boolean accept(File file) {
		return (recursive && file.isDirectory()) || (file.getName().endsWith(".class")
				&& file.getName().contains("$") == false && file.getName().startsWith("User"));
	}
}